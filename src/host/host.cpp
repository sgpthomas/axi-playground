...
int main(int argc, char* argv[])
{
   ...
   // Create the compute program from offline
	...
	printf("val: %d dev: %d bin: %d mem, %d\n", CL_INVALID_VALUE, CL_INVALID_DEVICE, CL_INVALID_BINARY, CL_OUT_OF_HOST_MEMORY);
   ...
   err = clBuildProgram(program, 0, NULL, NULL, NULL, NULL);
    ...
    //
     kernel = clCreateKernel(program, "Toplevel", &err);
    ...
    err = 0;
    // cl_uint d_scalar00 = 2000000000;
    cl_uint d_scalar00 = 40;
    err |= clSetKernelArg(kernel, 0, sizeof(cl_uint), &d_scalar00);
